...
const staticPages: PageDefinition[] = [
  page({
    ...
    title: "Websites, business apps and AI systems built around the business",
    description: "Discover Viste.ai services for website and app development, automation, knowledge, customer operations, data and custom AI delivery.",
    lead: "Bring us a simple brief or an operational bottleneck. We design, build and integrate the complete working system, from the client-facing experience to administration and data.",
  ...
  page({
    ...
    eyebrow: "Servicios",
    title: "Webs, aplicaciones de negocio y sistemas de IA pensados para la empresa",
    description: "Servicios de Viste.ai para desarrollo web y de aplicaciones, automatización, conocimiento, atención al cliente, datos e IA a medida.",
    lead: "Cuéntanos una idea sencilla o un problema operativo. Diseñamos, construimos e integramos el sistema completo, desde la experiencia del cliente hasta la administración y los datos.",
